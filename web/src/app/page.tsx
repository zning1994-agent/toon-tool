    ...
    <div className="app-container">
      <header className="app-header">
        <div className="app-logo">
          ...
          <span className="app-logo-text">{t.appName}</span>
        </div>
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .app-logo-icon {
          ...
          font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 14px; color: white;
        }
        .app-logo-text { font-size: 1.1rem; font-weight: 600; }
        .app-nav { display: flex; align-items: center; gap: 0.75rem; }
